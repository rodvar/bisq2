...
@Slf4j
public class DefaultMarketPriceService extends RateLimitedPersistenceClient<MarketPriceStore>
        implements Service, AuthorizedBondedRolesService.Listener, MarketPriceService {
    @Getter
    ...
    public DefaultMarketPriceService(com.typesafe.config.Config marketPrice,
