...
@Slf4j
public class ArbitratorTabView extends TabView<ArbitratorTabModel, ArbitratorTabController> {
    public ArbitratorTabView(ArbitratorTabModel model, ArbitratorTabController controller) {
        ...
        if (DevMode.isDevMode()) {
            addTab(Res.get("navigation.muSig"),
                    NavigationTarget.MU_SIG_ARBITRATOR,
                    styles);
        }
