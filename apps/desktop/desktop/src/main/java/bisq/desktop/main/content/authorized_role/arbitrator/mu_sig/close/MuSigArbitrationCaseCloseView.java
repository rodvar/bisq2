...
@Slf4j
public class MuSigArbitrationCaseCloseView extends NavigationView<VBox, MuSigArbitrationCaseCloseModel, MuSigArbitrationCaseCloseController> {
    private final Button closeButton, closeCaseButton;

    public MuSigArbitrationCaseCloseView(MuSigArbitrationCaseCloseModel model,
                                         MuSigArbitrationCaseCloseController controller,
                                         VBox arbitrationCaseOverviewComponent,
                                         VBox arbitrationCaseDetailComponent,
                                         VBox arbitrationResultComponent) {
        ...
        Label headline = new Label(Res.get("authorizedRole.arbitrator.arbitrationCaseClose.headline"));
        ...
        VBox content = new VBox(10,
                ...
                arbitrationResultComponent,
                closeCaseButtonRow
        );
        VBox.setMargin(arbitrationResultComponent, new Insets(10, 0, 0, 0));
