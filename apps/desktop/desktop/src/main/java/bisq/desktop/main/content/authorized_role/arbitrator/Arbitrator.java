...
public class Arbitrator {
    public static class Controller implements bisq.desktop.common.view.Controller {
        ...
        public Controller(ServiceProvider serviceProvider) {
            ArbitratorTabController arbitratorTabController = new ArbitratorTabController(serviceProvider);
            Model model = new Model();
            view = new View(model, this, arbitratorTabController.getView().getRoot());
        }
